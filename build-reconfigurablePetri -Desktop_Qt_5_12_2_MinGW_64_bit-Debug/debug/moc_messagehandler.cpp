...
#include "../../reconfigurablePetri/messagehandler.h"
...
QT_MOC_LITERAL(1, 15, 15), // "messageDelivred"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "MessageHandler\0messageDelivred\0"
};
...
void MessageHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->messageDelivred(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MessageHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageHandler::messageDelivred)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageHandler::messageDelivred()
{
