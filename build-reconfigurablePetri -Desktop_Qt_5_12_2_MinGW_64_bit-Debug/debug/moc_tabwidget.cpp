...
#include "../../reconfigurablePetri/tabwidget.h"
...
QT_MOC_LITERAL(1, 10, 13), // "canRedoChange"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "canRedo"
QT_MOC_LITERAL(4, 33, 13), // "canUndoChange"
QT_MOC_LITERAL(5, 47, 7), // "canUndo"
QT_MOC_LITERAL(6, 55, 10), // "tabChanged"
QT_MOC_LITERAL(7, 66, 5), // "index"
QT_MOC_LITERAL(8, 72, 12), // "errorMessage"
QT_MOC_LITERAL(9, 85, 3) // "msg"

    },
    "TabWidget\0canRedoChange\0\0canRedo\0"
    "canUndoChange\0canUndo\0tabChanged\0index\0"
    "errorMessage\0msg"
};
...
void TabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidget::canRedoChange)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TabWidget::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidget::canUndoChange)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidget::tabChanged)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidget::errorMessage)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void TabWidget::canRedoChange(bool _t1)
{
...
// SIGNAL 1
void TabWidget::canUndoChange(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void TabWidget::errorMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
